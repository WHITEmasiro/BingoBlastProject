...
#define AI_ACTION_INTERVAL_NORMAL CALL_NUMBER_TIME_INTERVAL + 3.5 //unit is second
#define AI_ACTION_INTERVAL_HARD CALL_NUMBER_TIME_INTERVAL + 1.5 //unit is second
